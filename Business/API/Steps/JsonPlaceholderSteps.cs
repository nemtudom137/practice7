...
namespace Business.API.Steps
{
    ...
    public class JsonPlaceholderSteps
    {
        ...
        public JsonPlaceholderSteps(IRequestBuilder builder, ScenarioContext scenarioContext)
        {
            usersClient = new UsersClient(builder);
            invalidClient = new InvalidEndpointClient(builder);
